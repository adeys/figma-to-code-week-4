...
export default function TestimonialSection() {
	return (
		<section className="container py-16">
			<h2 className="text-5xl mb-5 text-center py-5">My <strong>Testimonial</strong></h2>

			<div className="py-5 px-6 flex items-center justify-center gap-12">
				{testimonialData.map((testimonial, index) => (
					<div key={index} className={clsx('rounded-xl shadow-lg p-10 flex flex-col items-center gap-6', {'bg-primary text-primary-foreground': index % 2 !== 0})}>
						<img src={testimonial.avatar}
						     ...
						     width={96} height={96} />
						<p className="max-w-72 text-center text-sm">I recently had to jump on 10+ different calls across eight different countries to find the right owner.</p>
